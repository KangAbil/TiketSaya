    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ticketAdapter = new TicketAdapter(MyProfileAct.this,list); //me-replace data atau mengganti data
                myticket_place.setAdapter(ticketAdapter); //mengatur adapter atau mensetting-nya disini dari ticketAdapter
            }
        ...
        btn_sign_out.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString(username_key, null); // ketika button sign out di klik dia akan menghapus dan dijadikan null datanya
                editor.apply();

                //pindah activity
                Intent gotosignin = new Intent(MyProfileAct.this, SignInAct.class);
                startActivity(gotosignin);
                finish(); //finish(); agar tidak bisa kembali lagi ke halaman MyProfileAct
            }
        });
