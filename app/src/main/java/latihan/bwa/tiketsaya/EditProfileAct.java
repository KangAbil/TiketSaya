...
public class EditProfileAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //value username_key_new sudah ada dikarenakan dipanggil dari getUsernameLocal()
        getUsernameLocal();

        reference = FirebaseDatabase.getInstance().getReference().child("Users").child(username_key_new);
        storage = FirebaseStorage.getInstance().getReference().child("Photousers").child(username_key_new);

        /* addValueEvenetListener mengubah data secara realTime(langsung)
           apabila addListenerforSingleValueEvent harus close aplikasi terlebih dahulu  */
