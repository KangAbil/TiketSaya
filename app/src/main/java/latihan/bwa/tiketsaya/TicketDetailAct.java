...
public class TicketDetailAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String jenis_tiket_baru = bundle.getString("jenis_tiket"); //key harus sesuai name pada HomeAct apabila tidak maka akan tercetak null

//        Toast.makeText(getApplicationContext(),"Jenis Tiket " + jenis_tiket_baru,Toast.LENGTH_SHORT).show(); hanya pemanggilan sementara
